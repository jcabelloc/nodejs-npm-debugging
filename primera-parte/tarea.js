...
const server = http.createServer((req, res) => {
    ...
    if (url=== '/') {
        ...
        res.write('<body><h1>Saludos desde mi primera Tarea</h1><form action="/crear-usuario" method="POST"><input type="text" name="nombreusuario"></input><button type="submit">Crear</button></form></body>');
        res.write('</html>');
        return res.end();
    }
    if (url=== '/usuarios') {
